    ...
    props: {
      ...
      ranges: {
        ...
        default () {
          ...
          return {
            [this.localeData.range[0]]: [today, todayEnd],
            [this.localeData.range[1]]: [yesterdayStart, yesterdayEnd],
            [this.localeData.range[2]]: [thisMonthStart, thisMonthEnd],
            [this.localeData.range[3]]: [
              new Date(today.getFullYear(), 0, 1),
              new Date(today.getFullYear(), 11, 31, 11, 59, 59, 999)
            ],
            [this.localeData.range[4]]: [
